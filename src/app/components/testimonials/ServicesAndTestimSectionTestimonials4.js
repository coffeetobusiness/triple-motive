...
export default function ServicesAndTestimSectionTestimonials4() {
    return (
        <React.Fragment>
            <>
        ...
        <div className="w-full lg:w-1/3 px-4">
          <div className="max-w-md mx-auto mb-8 lg:mb-0 p-6 rounded-3xl overflow-hidden bg-white">
            <div className="pb-7 mb-3 border-b border-gray-100">
              ...
              <p className="text-lg text-black">It was a pleasure working with the Saturn. They understood the brief correctly and delivered great designs exceeding the expectations.</p>
            </div>
            <div className="flex items-center">
              <img className="w-14 h-14 rounded-full" src="casper-assets/testimonials/avatar-4.png" alt />
              <div className="ml-4">
                <span className="block text-lg font-medium text-black">Kristin Watson</span>
        ...
        <div className="w-full lg:w-1/3 px-4">
          <div className="max-w-md mx-auto p-6 rounded-3xl overflow-hidden bg-white">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <span className="block text-lg font-medium text-black">Kathryn Murphy</span>
                <span className="block text-sm text-gray-600">Founder ABC Studio</span>
              </div>
            </div>
          </div>
        </div>
