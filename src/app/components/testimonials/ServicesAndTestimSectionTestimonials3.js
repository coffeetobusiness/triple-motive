...
export default function ServicesAndTestimSectionTestimonials3() {
    return (
        <React.Fragment>
            <>
                <section className="relative pt-24 pb-12 sm:py-24 lg:py-32 bg-body overflow-hidden">
  <div className="relative container mx-auto px-4">
    <div className="max-w-xl lg:max-w-none mx-auto">
      <div className="flex flex-wrap items-center -mx-4">
        <div className="relative w-full lg:w-1/2 px-4 mb-20 lg:mb-0">
          <img className="absolute top-0 right-0 mr-20 -mt-20 animate-spinStar" src="casper-assets/testimonials/blink-star.png" alt />
          <div className="relative max-w-md xl:max-w-xl mx-auto lg:mx-0">
            <span className="inline-flex items-center px-3.5 h-7 mb-9 text-xs font-medium text-white leading-6 bg-gradient-tag rounded-full">TESTIMONIALS</span>
            <p className="text-3xl text-white font-medium leading-tight mb-8">The AI chat assistant not only engages visitors but also collects valuable data and insights. We now have a better understanding of our customers' preferences and can tailor our offerings accordingly. ChatBotX is a must-have for any business.</p>
            <div className="mb-8">
              <span className="block text-2xl text-white font-medium">Beby Jennifer</span>
              <span className="text-lg text-gray-500">CEO of an IT Solutions Company</span>
            </div>
            <div>
        ...
        <div className="w-full lg:w-1/2 px-4">
          <div className="relative flex items-center justify-center max-w-md xl:max-w-lg mx-auto lg:mx-0 lg:mr-0 px-16 h-112 lg:h-128 rounded-3xl overflow-hidden">
            <img className="relative z-10 block w-full" src="casper-assets/testimonials/logo-big.svg" alt />
            <img className="absolute top-0 left-0 block w-full h-full object-cover" src="casper-assets/testimonials/bg-gradient-color.png" alt />
          </div>
        </div>
      </div>
    </div>
