...
export default function ServicesAndTestimSectionTestimonials8() {
    return (
        <React.Fragment>
            <>
                <section className="relative pb-12 xl:pb-0 bg-body overflow-hidden">
    ...
    <div className="flex flex-wrap items-center -mx-4">
      <div className="w-full xl:w-2/5 px-4 mb-32 xl:mb-0">
        <div className="relative max-w-xl xl:max-w-md mx-auto xl:mx-0">
          <img className="mb-6 animate-spinStar" src="casper-assets/testimonials/blink-star.png" alt />
          <div className="relative z-10">
            <h2 className="font-heading text-4xl xs:text-5xl sm:text-6xl font-medium text-white tracking-tight mb-8">Trusted by more than 100k people</h2>
      ...
      <div className="relative w-full xl:w-3/5 px-4 overflow-hidden h-186">
        <div className="absolute top-0 left-0 z-10 w-full h-52 bg-gradient-to-b from-darkBlue-900 to-transparent" />
        <div className="absolute z-10 bottom-0 left-0 w-full h-52 bg-gradient-to-t from-darkBlue-900 to-transparent" />
        <div className="max-w-xl md:max-w-3xl mx-auto xl:mr-0">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full sm:w-1/2 px-4">
              <div className="md:slider-2 h-full">
                <div className="slider-container-2">
                  <div className="md:slide-2 p-6 mb-6 rounded-3xl shadow-box-violet overflow-hidden bg-white bg-opacity-10">
                    <div className="pb-6 mb-6 border-b border-gray-700">
                      <p className="text-white mb-6">Casper has become an invaluable asset to our website. The AI chat assistant not only engages visitors but also collects valuable data and insights.</p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        <span className="block text-lg text-white">Guy Hawkins</span>
                        <span className="block text-sm text-white">Louis Vuitton</span>
                      </div>
                    </div>
                  </div>
                  <div className="md:slide-2 p-6 mb-6 rounded-3xl shadow-box-violet overflow-hidden bg-white bg-opacity-10">
            ...
            <div className="w-full sm:w-1/2 px-4">
              <div className="md:slider-2 h-full">
                <div className="slider-container-2 slide-2">
                  <div className="md:slide-2 p-6 mb-6 rounded-3xl shadow-box-violet overflow-hidden bg-white bg-opacity-10">
                    <div className="pb-6 mb-6 border-b border-gray-700">
                      <p className="text-white mb-6">Casper has become an invaluable asset to our website. The AI chat assistant not only engages visitors but also collects valuable data and insights.</p>
                      <div className="flex items-center">
