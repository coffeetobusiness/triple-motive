...
export default function IndexSectionTestimonials11() {
  ...
  const selectedTestimonials = Testimonials.slice(startIndex, startIndex + testimonialsPerPage);
                ...
                <div className="w-full lg:w-2/5 xl:w-1/2 px-4">
                  <div className="lg:text-right">
                    <button
                      ...
                      className="inline-flex w-14 h-14 mr-2.5 items-center justify-center text-gray-300 hover:text-black border border-white hover:border-violet-500 hover:bg-violet-500 rounded-full transition duration-150">
                    ...
                    <button
                      onClick={handleNext}
                      className="inline-flex w-14 h-14 items-center justify-center text-gray-300 hover:text-black border border-white hover:border-violet-500 hover:bg-violet-500 rounded-full transition duration-150">
                      <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      >
                        <div className="max-w-md mx-auto mb-8 lg:mb-0 p-6 rounded-3xl overflow-hidden bg-white">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-4">
                              <span className="block text-lg font-medium text-black">{testimonial.name}</span>
                              <span className="block text-sm text-gray-600">{testimonial.post}</span>
                            </div>
                          </div>
                        </div>
                      </motion.div>
