...
export default function MoreCompSectionFooter7() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="relative container mx-auto px-4">
    ...
    <div className="pt-10 border-t border-gray-800">
      <div className="md:flex items-center justify-between">
        <div className="-mb-4"><a className="inline-block mb-4 mr-10 text-gray-500 hover:text-white tracking-tight" href="#">About Us</a><a className="inline-block mb-4 mr-10 text-gray-500 hover:text-white tracking-tight" href="#">Our Work</a><a className="inline-block mb-4 mr-10 text-gray-500 hover:text-white tracking-tight" href="#">Discover</a><a className="inline-block mb-4 text-gray-500 hover:text-white tracking-tight" href="#">Contact Us</a></div>
        <div>
          <span className="text-gray-600 tracking-tight">© Casper. All rights reserved</span>
        </div>
      </div>
    </div>
  </div>
