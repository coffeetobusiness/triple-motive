...
export default function MoreCompSectionAbout9() {
    return (
        <React.Fragment>
            <>
  ...
  <img className="absolute top-0 right-0 h-full -mr-64 lg:-mr-0 z-10" src="casper-assets/about/double-lines-lg-right.svg" alt />
  <img className="hidden md:block absolute top-1/2 right-0 transform -translate-y-1/2 z-10 h-full w-1/5 sm:w-2/5 object-contain" src="casper-assets/about/robot-lg.png" alt />
  <div className="relative container mx-auto px-4">
    <div className="relative max-w-lg lg:max-w-2xl mx-auto md:mx-0">
      <h2 className="font-heading text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-medium text-white tracking-tight mb-4">About Us</h2>
      ...
      <p className="text-lg text-gray-400 leading-relaxed tracking-tight mb-6">Whether you need a chatbot for customer support, sales, lead generation, or any other use case, our platform is versatile enough to cater to your specific requirements. Our APIs and integration capabilities allow for easy deployment across websites, applications, and messaging platforms, providing a consistent experience for your users.</p>
      ...
      <div className="mt-14">
        <div className="relative flex flex-col sm:flex-row">
          <div className="pb-8 sm:pb-0 sm:pr-8">
            <span className="block text-5xl lg:text-7xl text-white font-medium">300+</span>
            <span className="block text-gray-500 tracking-tight">PRODUCTS</span>
          </div>
          <div className="relative py-8 sm:py-0 sm:px-8">
            <span className="block text-5xl lg:text-7xl text-white font-medium">100+</span>
            <span className="block text-gray-500 tracking-tight">WEB TEMPLATE</span>
          ...
          <div className="pt-8 sm:pt-0 sm:pl-8">
            <span className="block text-5xl lg:text-7xl text-white font-medium">215</span>
            <span className="block text-gray-500 tracking-tight">MOBILE TEMPLATE</span>
          </div>
        </div>
      </div>
    </div>
