...
export default function FeaturescompoSectionFeatures2() {
    return (
        <React.Fragment>
            <>
                <section className="relative py-12 md:py-24 bg-body overflow-hidden">
  <img className="absolute bottom-0 right-0" src="casper-assets/features/double-line-circle.svg" alt />
  <img className="hidden md:block z-10 absolute top-0 left-0 mt-24 ml-4 lg:ml-24 xl:ml-64 animate-spinStar" src="casper-assets/features/blink-star.png" alt />
  <div className="relative container mx-auto px-4">
    ...
    <div className="relative">
      <div className="max-w-xl mx-auto mb-16 text-center">
        <h2 className="font-heading text-4xl xs:text-5xl sm:text-6xl md:text-7xl font-medium text-white tracking-tight mb-6">Intelligent Conversations</h2>
        <p className="text-xl text-gray-400">Casper is powered by state-of-the-art artificial intelligence and ensuring natural and meaningful interactions</p>
      </div>
      <div className="flex flex-wrap -mx-4">
        <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
          <div className="max-w-md mx-auto h-full p-8 rounded-3xl shadow-box-violet overflow-hidden bg-white bg-opacity-10">
            ...
            <p className="text-xl text-gray-400">Powered by state-of-the-art artificial intelligence, ensuring natural and meaningful</p>
          </div>
        </div>
        <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
          <div className="max-w-md mx-auto h-full p-8 rounded-3xl shadow-box-orange overflow-hidden bg-white bg-opacity-10">
            ...
            <p className="text-xl text-gray-400">Whether you're a tech guru or a beginner, you'll have your AI chat assistant up</p>
          </div>
        </div>
          ...
          <div className="max-w-md mx-auto h-full p-8 rounded-3xl shadow-box-green overflow-hidden bg-white bg-opacity-10">
            <div className="flex mb-12 items-center">
              <div className="flex-shrink-0 flex mr-4 items-center justify-center w-16 h-16 rounded-full bg-sky-500">
                <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6 9C6 5.68629 8.68629 3 12 3V3C15.3137 3 18 5.68629 18 9V15C18 18.3137 15.3137 21 12 21V21C8.68629 21 6 18.3137 6 15V9Z" stroke="white" strokeWidth={2} strokeLinejoin="round" />
                  <path d="M12 7L12 11" stroke="white" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              <div>
                <h4 className="text-2xl font-medium text-white leading-tight">
            ...
            <p className="text-xl text-gray-400">Gain valuable insights into your users' preferences, behavior, and frequently asked questions</p>
          </div>
        </div>
      </div>
    </div>
