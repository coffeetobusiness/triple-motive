...
export default function MoreComponentsSectionHeaders7() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="relative pt-36">
    <div className="relative z-10 container mx-auto px-4">
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-white font-semibold leading-none mb-8">INTRODUCING CASPER AI</h1>
        <p className="text-2xl text-gray-400 mb-8">the cutting-edge AI chat assistant that will transform your website into a dynamic hub of personalized conversations.</p>
        <div>
      ...
      <div className="flex flex-wrap items-start justify-between mt-24">
        <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center">
            <img className="block mb-8 sm:mb-0 sm:mr-10" src="casper-assets/headers/logo-placeholder1.svg" alt />
            <img className="block mb-8 sm:mb-0 sm:mr-10" src="casper-assets/headers/logo-placeholder2.svg" alt />
            <img className="block" src="casper-assets/headers/logo-placeholder3.svg" alt />
          </div>
        </div>
        <div className="w-full lg:w-auto">
          <h3 className="text-sm uppercase text-gray-600 mb-4">TRUSTED BY BIG COMPANIES</h3>
          <div className="flex items-center">
            <img className="block w-10 h-10 rounded-full" src="casper-assets/headers/avatar-people1.png" alt />
            <img className="block -ml-2 w-10 h-10 rounded-full" src="casper-assets/headers/avatar-people2.png" alt />
            <img className="block -ml-2 w-10 h-10 rounded-full" src="casper-assets/headers/avatar-people3.png" alt />
            <img className="block -ml-2 w-10 h-10 rounded-full" src="casper-assets/headers/avatar-people4.png" alt />
            <img className="block -ml-2 w-10 h-10 rounded-full" src="casper-assets/headers/avatar-number.png" alt />
          </div>
        </div>
      </div>
      <img className="absolute top-0 right-0 -mt-32 md:-mt-20 lg:mr-20 animate-spinStar" src="casper-assets/headers/blink.png" alt />
      <img className="absolute top-0 left-0 -mt-20 md:-ml-10 h-20 animate-spinStar" src="casper-assets/headers/blink-sm.png" alt />
      <img className="hidden md:block absolute bottom-0 right-0 -mr-24 lg:-mr-0 mb-20 lg:mb-36" src="casper-assets/headers/plant-robot-left.png" alt />
      <img className="hidden lg:block absolute top-0 left-0" src="casper-assets/headers/chip-skew.png" alt />
    </div>
  </div>
