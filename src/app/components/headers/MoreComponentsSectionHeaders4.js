...
export default function MoreComponentsSectionHeaders4() {
    return (
        <React.Fragment>
            <>
                <section className="relative pb-8 bg-body overflow-hidden">
  ...
  <div className="relative py-10">
    <img className="hidden sm:block absolute bottom-0 right-0 xl:mr-20 md:mb-10 animate-spinStar" src="casper-assets/headers/blink.png" alt />
    <img className="hidden sm:block absolute top-0 left-0 md:ml-16 mt-4 animate-spinStar" src="casper-assets/headers/blink-sm.png" alt />
    <div className="container mx-auto px-4">
      <div className="text-center">
        <h1 className="font-heading text-6xl md:text-8xl xl:text-9xl font-semibold text-white tracking-tight">
          <span>CASPER</span>
          <span className="-ml-4 bg-clip-text text-transparent bg-gradient-to-br from-violet-900 via-blueGray-900 to-sky-900">AI</span>
        </h1>
      </div>
    </div>
  </div>
  <div className="relative container mx-auto px-4">
    <div className="flex flex-wrap -mx-4">
      <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
        <a className="group block max-w-md mx-auto lg:max-w-none bg-radial to-indigo-900 from-blueGray-800 rounded-3xl overflow-hidden" href="#">
          <div className="relative h-148 bg-opacity-0 bg-blueGray-800 group-hover:bg-opacity-100 transition duration-500">
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
              <img className="h-96 transform group-hover:scale-105 transition duration-300" src="casper-assets/headers/plant-robo.png" alt />
            </div>
      ...
      <div className="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
        <a className="group block max-w-md mx-auto lg:max-w-none bg-radial to-orange-800 from-orange-600 rounded-3xl overflow-hidden" href="#">
          <div className="relative h-148 bg-opacity-0 bg-orange-600 group-hover:bg-opacity-100 transition duration-500">
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
              <img className="h-96 transform group-hover:scale-105 transition duration-300" src="casper-assets/headers/box-items.png" alt />
            </div>
            <div className="relative flex flex-col p-10 h-full">
              <span className="block text-5xl text-white font-medium">02</span>
              <span className="block mt-auto text-4xl text-white">Image</span>
              <span className="block text-4xl text-white">Optimzing</span>
            </div>
          </div>
        </a>
      </div>
      <div className="w-full lg:w-1/3 px-4">
        <a className="group block max-w-md mx-auto lg:max-w-none bg-radial to-teal-800 from-teal-600 rounded-3xl overflow-hidden" href="#">
          <div className="relative h-148 bg-opacity-0 bg-teal-600 group-hover:bg-opacity-100 transition duration-500">
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
              <img className="h-96 px-4 transform group-hover:scale-105 transition duration-300" src="casper-assets/headers/robot-knight.png" alt />
            </div>
            <div className="relative flex flex-col p-10 h-full">
              <span className="block text-5xl text-white font-medium">02</span>
