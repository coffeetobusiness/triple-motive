...
export default function MoreComponentsSectionHeaders5() {
    return (
        <React.Fragment>
            <>
  ...
  <img className="absolute top-0 right-0 opacity-80" src="casper-assets/headers/circle-double-element-dark.svg" alt />
  <div className="relative pt-24">
    <div className="relative z-10 container mx-auto px-4">
      <div className="max-w-lg mx-auto lg:max-w-none">
        <h1 className="font-heading text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-white font-semibold leading-none mb-8">
          <span>AI FOR</span>
          <span className="inline-block bg-clip-text text-transparent bg-gradient-to-br from-violet-900 via-blueGray-900 to-sky-900">CHAT</span>
          <span className="block leading-none bg-clip-text text-transparent bg-gradient-to-br from-violet-900 via-blueGray-900 to-sky-900">ASSISTANT</span>
        </h1>
        ...
        <div className="flex items-center">
          <div className="mr-3">
            <img className="block w-10 h-10 animate-spinStar" src="casper-assets/headers/blink-sm.png" alt />
          </div>
          <div>
            <p className="text-sm text-sky-800 leading-snug">
              <span className="block">Micro Office For Startups -</span>
              <span>Connection Club</span>
            </p>
          </div>
        </div>
      </div>
    </div>
    <div className="hidden lg:block absolute top-0 right-0 w-1/2 xl:w-full xl:h-170">
      <div className="absolute top-0 right-0 -mt-12 w-160 h-160 bg-gradient-to-t from-purple-700 to-darkBlue-900 rounded-full filter blur-4xl" />
      <img className="absolute top-0 right-0 mt-40" src="casper-assets/headers/planet-lg.png" alt />
      <img className="absolute top-0 right-0 mt-20 mr-16 h-160" src="casper-assets/headers/robot-with-wrench.png" alt />
    </div>
    <div className="relative block lg:hidden h-128 md:h-170">
      <div className="absolute top-0 right-0 w-160 h-160 bg-gradient-to-t from-purple-700 to-darkBlue-900 rounded-full filter blur-4xl" />
      <img className="absolute top-0 right-0 mt-40 h-96 md:h-auto" src="casper-assets/headers/planet-lg.png" alt />
      <img className="absolute top-0 right-0 mt-20 h-112 md:h-160" src="casper-assets/headers/robot-with-wrench.png" alt />
    </div>
  </div>
