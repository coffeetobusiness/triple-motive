...
export default function MoreComponentsSectionHeaders6() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="relative">
    <img className="hidden lg:block absolute top-0 left-0 w-5/12 h-full object-cover" src="casper-assets/headers/photo-left-side.png" alt />
    <div className="relative z-10 container mx-auto px-4">
      <div className="max-w-lg xl:max-w-2xl mx-auto lg:mr-0 pt-24 sm:pt-40 pb-32 z-10">
        <h1 className="font-heading text-4xl xs:text-5xl sm:text-6xl lg:text-7xl xl:text-8xl text-white font-semibold leading-none mb-8">INTRODUCING CASPER AI</h1>
        <p className="text-2xl text-gray-400 mb-8">the cutting-edge AI chat assistant that will transform into a dynamic hub of personalized conversations.</p>
        <div className="mb-20">
        ...
        <div>
          <h3 className="text-sm uppercase text-gray-600 mb-4">SATISFIED USERS</h3>
      ...
      <img className="absolute bottom-0 right-0 -mr-10 mb-16 animate-spinStar" src="casper-assets/headers/blink.png" alt />
    </div>
    <img className="block lg:hidden w-full h-135 object-cover" src="casper-assets/headers/photo-left-side.png" alt />
  </div>
